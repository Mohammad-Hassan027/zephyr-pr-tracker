...
export default function ClubsError({
  ...
  useEffect(() => {
    console.error("Clubs directory error:", error);
  }, [error]);
    ...
    <>
      ...
      <main className="page-shell flex min-h-[70vh] items-center justify-center">
        <div className="surface-card w-full max-w-md p-8 text-center space-y-4">
          ...
          <h1 className="page-title text-xl sm:text-2xl">Could not load clubs</h1>
          <p className="page-subtitle text-zinc-500 text-sm">
            {error?.message || "An unexpected error occurred while loading the clubs directory."}
          </p>
